  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow p-5 mb-6">
        <h2 className="font-medium mb-3">{editingId ? 'Edit Customer' : 'Tambah Customer Baru'}</h2>
      ...
      <div className="bg-white rounded-xl shadow overflow-hidden">
        <table className="w-full text-sm">
          ...
          <tbody>
            ...
            {customers.length === 0 && (
              <tr><td colSpan={4} className="p-3 text-center text-gray-400">Belum ada customer</td></tr>
            )}
          </tbody>
        </table>
      </div>
